...
namespace IngSoftProyecto.Migrations
{
    ...
    [Migration("20251025012100_casifinal")]
    partial class casifinal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IngSoftProyecto.Models.Persona", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IngSoftProyecto.Models.Entrenador", b =>
                {
                    b.HasBaseType("IngSoftProyecto.Models.Persona");
            ...
            modelBuilder.Entity("IngSoftProyecto.Models.Entrenador", b =>
                {
                    b.HasOne("IngSoftProyecto.Models.Persona", null)
                        .WithOne()
                        .HasForeignKey("IngSoftProyecto.Models.Entrenador", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("IngSoftProyecto.Models.Miembro", b =>
                {
                    ...
                    b.HasOne("IngSoftProyecto.Models.Persona", null)
                        .WithOne()
                        .HasForeignKey("IngSoftProyecto.Models.Miembro", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
